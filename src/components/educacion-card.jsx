...
export default function EducacionCard({ fecha, nombre, titulo, image_url}) {
  return (
    <Card className="flex flex-col w-full h-full p-4 transition-colors border bg-zinc-400 dark:bg-black dark:border-zinc-800 border-zinc-400 bg-gradient-to-tl dark:from-black/80 from-zinc-50 dark:via-zinc-600/20 via-zinc-200/60 dark:to-black/80 to-zinc-50 dark:hover:bg-zinc-950 hover:bg-zinc-400/60 hover:dark:border-white/80 hover:border-black/80">
